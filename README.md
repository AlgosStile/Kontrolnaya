...
*  Снабдить репозиторий оформленным текстовым описанием решения (файл readme.txt)
...
В папке Chema находится файл с изображением блок-схемы.
